        ...
        {activeTab === 'dashboard' && (
          <div className="page active">
            ...
            <div style={{display: 'flex', flexDirection: 'column', gap: '1.5rem'}}>
              {/* TOP ROW: 2 Premium Horizontal Cards */}
        ...
        {activeTab === 'prep' && (
          <div className="page active">
            ...
            <div className="neet-layout">
                  ...
                  return (
                    <div key={data.id} className="card" style={{padding: '1.5rem'}}>
                      <div style={{display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem'}}>
                        <div style={{fontSize: '16px', fontWeight: 700}}>{data.label} Tracker</div>
                        <div style={{textAlign: 'right', minWidth: '120px'}}>
                          <div style={{fontSize: '11px', color: 'var(--muted)', marginBottom: '4px'}}>{doneQs}/{data.questions.length} Mastered</div>
                      ...
                      <div style={{display: 'flex', flexDirection: 'column', gap: '10px'}}>
                        {data.questions.map((q, qi) => {
                          ...
                          return (
                            <div key={qi} className="qa-card" style={{margin: 0, paddingLeft: '1rem', borderLeftColor: prepDone[key] ? 'var(--success)' : 'var(--border)'}}>
                              <div 
                                style={{padding: '12px 10px', display: 'flex', gap: '12px', alignItems: 'center', cursor: 'pointer'}}
                              ...
                              >
                                <div style={{
                                  ...
                                  background: prepDone[key] ? 'var(--success)' : 'transparent', display: 'flex', alignItems: 'center', justifyContent: 'center'
                                }} onClick={(e) => { e.stopPropagation(); togglePrep(data.id, qi); }}>
                                  {prepDone[key] && <FiCheckCircle style={{fontSize: '12px', color: 'var(--bg)'}}/>}
                                </div>
                                <div style={{flex: 1, fontSize: '14px', fontWeight: 600, color: prepDone[key] ? 'var(--dim)' : 'var(--text)'}}>
                                  {q.q}
                                </div>
                              </div>
                              {isExpanded && (
                                <div style={{padding: '0 10px 15px 30px', animation: 'fadeIn 0.2s'}}>
                                  <div style={{fontSize: '12px', color: 'var(--secondary)', fontWeight: 700, marginBottom: '8px', textTransform: 'uppercase'}}>Verbal Structure:</div>
                                  <div style={{fontSize: '13px', lineHeight: '1.6', color: 'var(--muted)', background: 'var(--surf-light)', padding: '1rem', borderRadius: '10px', borderLeft: '3px solid var(--primary)'}}>
                                    "{q.answer}"
                                  </div>
                                </div>
                              )}
              ...
              <div className="neet-side-col">
                <div className="card" style={{border: '1.5px solid var(--warning-soft)'}}>
                   <div className="card-title" style={{color: 'var(--warning)'}}>Gap Strategy</div>
